  ...
  return (
    <footer className="max-w-7xl mx-auto border-x border-(--gray-500) border-b w-full">
      <div className="grid grid-cols-4">
        <div className="py-6 border-r border-(--gray-500)"></div>
        <div className="py-6 col-span-2 border-r border-(--gray-500)"></div>
        <div className="py-6"></div>
      </div>
      <div className="border-t border-(--gray-500) grid grid-cols-4">
        <div className="grid grid-cols-2 grid-rows-2">
          <div className="col-span-2 p-6 border-b border-r border-(--gray-500)">
            <p className="text-xl">Follow Me</p>
          </div>
          <div className="grid grid-cols-2 col-span-2">
          <span className="p-2 border-r border-b border-(--gray-500)">Insta</span>
          <span className="p-2 border-r border-b border-(--gray-500)">Facebook</span>
          <span className="p-2 border-r border-(--gray-500)">Linkedin</span>
          <span className="p-2 border-r border-(--gray-500)">Youtube</span>
          </div>
        </div>
        <div className="p-6 border-r border-(--gray-500)">
      ...
      <div className="p-2 border-t border-(--gray-500)">
        c 2025 All Rights Reserved Learning
      </div>
    </footer>
  );
}
