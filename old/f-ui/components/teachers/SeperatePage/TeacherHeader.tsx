  ...
  return (
    <div className="">
      ...
      <div className="px-4 flex flex-col h-24 justify-center">
        <p className="text-base space-x-2 text-center">
        ...
        <span className="text-3xl font-semibold flex items-center gap-2 p-2">
          {teacher.name}
      ...
      <div className="text-base mt-2 text-zinc-500 pr-4">{teacher.bio}</div>
    </div>
  );
}
